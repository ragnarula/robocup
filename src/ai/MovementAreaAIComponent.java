...
public class MovementAreaAIComponent extends AbstractSimpleAIComponent {
    ...
    public MovementAreaAIComponent() {
        ...
        MOVEMENT_AREAS.put(0, new MovementArea(-20.0, -30.0, 20.0, -53.5));
        MOVEMENT_AREAS.put(1, new MovementArea(-35.0, 53.5, 20.0, 0));
        MOVEMENT_AREAS.put(2, new MovementArea(-35.0, 53.5, 20.0, -5));
